  ...
  Future<void> _audioPlayerStateChange(MethodCall call) async {
    switch (call.method) {
      ...
      case "audio.onError":
        ...
        break;
      case "audio.remoteOnPause":
        _state = AudioPlayerState.PAUSED;
        _playerStateController.add(AudioPlayerState.PAUSED);
        print("Dart side: audio.remoteOnPause");
        break;
      case "audio.remoteOnPlay":
        _state = AudioPlayerState.PLAYING;
        _playerStateController.add(AudioPlayerState.PLAYING);
        print("Dart side: audio.remoteOnPlay");
        break;
      case "audio.remoteOnNextTrack":
        // Handle next track case
        print("Dart side: audio.remoteOnNextTrack");
        break;
      case "audio.remoteOnPrevTrack":
        // Handle prev track case
        print("Dart side: audio.remoteOnPrevTrack");
        break;
      default:
